...
# Configures git remotes (origin = your fork, upstream = auravox-hq/auravox),
...
UPSTREAM_URL="https://github.com/auravox-hq/auravox.git"
...
echo -e "${BLUE}╔══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║              Auravox Contributor Bootstrap                    ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
canonical_https="https://github.com/auravox-hq/auravox.git"
canonical_ssh="git@github.com:auravox-hq/auravox.git"
...
if $needs_fork_prompt; then
    echo -e "${YELLOW}Enter your fork URL (e.g. https://github.com/<YOUR_HANDLE>/auravox.git):${NC}"
    read -r -p "> " FORK_URL
    if [[ -z "$FORK_URL" ]]; then
...
if [[ -z "$existing_upstream" ]]; then
    ...
    echo -e "${YELLOW}Reset upstream to auravox-hq/auravox? [y/N]:${NC}"
