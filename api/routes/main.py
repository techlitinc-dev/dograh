...
async def active_calls(
    x_auravox_devops_secret: Annotated[
        str | None,
        Header(alias=AURAVOX_DEVOPS_SECRET_HEADER),
    ] = None,
) -> ActiveCallsResponse:
