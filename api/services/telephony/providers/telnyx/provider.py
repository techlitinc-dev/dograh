...
class TelnyxProvider(TelephonyProvider):
    ...
    async def initiate_call(
        ...
        **kwargs: Any,
        ...
        # stream_bidirectional_codec controls only the Auravox → Telnyx direction.
        # The Telnyx → Auravox direction follows the PSTN leg and is announced via
    ...
    async def handle_websocket(
        ...
        try:
            ...
            # inbound direction (Telnyx → Auravox); the outbound direction is
