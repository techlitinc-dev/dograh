...
This module implements the telephony provider abstraction for Auravox AI. For user-facing documentation, see the [Mintlify docs](https://docs.auravox.ai/integrations/telephony/overview).
...
See the [Custom Provider Guide](https://docs.auravox.ai/integrations/telephony/custom) in the documentation for detailed implementation instructions.
...
- [User Documentation](https://docs.auravox.ai/integrations/telephony/overview)
- [Twilio Integration](https://docs.auravox.ai/integrations/telephony/twilio)
- [Custom Providers](https://docs.auravox.ai/integrations/telephony/custom)
- [Webhooks Guide](https://docs.auravox.ai/integrations/telephony/webhooks)
