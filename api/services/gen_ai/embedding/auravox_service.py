"""Auravox-managed embedding service.

Routes embeddings through Auravox's managed proxy (MPS). This mirrors the managed
voice services (``AuravoxLLMService`` / ``AuravoxTTSService``): when a server-minted
...
class AuravoxEmbeddingService(OpenAIEmbeddingService):
    """OpenAI-compatible embedding client pointed at Auravox's managed proxy."""
    ...
    def __init__(
        ...
        Args:
            ...
            api_key: Auravox-managed MPS service key.
