"""Tests for the Python runtime SDK (`auravox_sdk`).
...
import pytest
from auravox_sdk import Workflow
from auravox_sdk._generated_models import NodeSpec
from auravox_sdk.errors import ValidationError
...
class _StubClient:
    """Stand-in for AuravoxClient backed by the in-process spec registry.
...
def test_webhook_complex_fields_validate(client: _StubClient):
    ...
    wh = wf.add(
        ...
        custom_headers=[{"key": "X-Source", "value": "auravox"}],
