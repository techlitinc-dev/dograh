"""Tests for CAMB AI TTS integration into Auravox.
...
class TestServiceFactoryCamb:
    def test_create_tts_service_camb(self):
        ...
        auravox_modules = [
            "pipecat.services.auravox",
            "pipecat.services.auravox.llm",
            "pipecat.services.auravox.stt",
            "pipecat.services.auravox.tts",
            "pipecat.utils.text.xml_function_tag_filter",
        ]
        mocks = {}
        for mod in auravox_modules:
