...
class _TestAuravoxGeminiLiveLLMService(AuravoxGeminiLiveLLMService):
    """Auravox Gemini service with client creation stubbed for unit tests."""
...
def _make_service() -> _TestAuravoxGeminiLiveLLMService:
    service = _TestAuravoxGeminiLiveLLMService(api_key="test-key")
