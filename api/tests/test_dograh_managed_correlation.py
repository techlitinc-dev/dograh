...
from pipecat.services.auravox.llm import AuravoxLLMService
from pipecat.services.auravox.stt import AuravoxSTTService
from pipecat.services.auravox.tts import AuravoxTTSService
...
def test_auravox_llm_uses_explicit_mps_correlation_id():
    service = AuravoxLLMService(
        api_key="mps-secret",
...
@pytest.mark.asyncio
async def test_auravox_stt_config_uses_explicit_mps_correlation_id(monkeypatch):
...
@pytest.mark.asyncio
async def test_auravox_tts_messages_use_explicit_mps_correlation_id(monkeypatch):
    fake_ws = _FakeWebSocket()
...
@pytest.mark.asyncio
async def test_auravox_tts_final_for_missing_context_is_ignored():
    service = AuravoxTTSService(api_key="mps-secret")
