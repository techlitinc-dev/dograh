...
from api.errors.failure import AuravoxFailure, ErrorSource, ErrorType, log_failure
    ...
    if not isinstance(error, TelephonyError):
        try:
            ...
            return AuravoxFailure(
                ...
                external_message="Auravox could not process the inbound telephony validation result.",
                provider=provider,
                retryable=None,
                context={
