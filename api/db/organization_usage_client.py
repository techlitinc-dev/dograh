...
class OrganizationUsageClient(BaseDBClient):
        ...
        async with self.async_session() as session:
            ...
            for run in runs:
                ...
                run_data = {
                    ...
                    "auravox_token_usage": auravox_tokens,
    ...
    async def get_daily_usage_breakdown(
        ...
        async with self.async_session() as session:
            ...
            total_minutes = 0
            total_cost_usd = 0
            total_auravox_tokens = 0

            for row in daily_usage:
                seconds = row.total_seconds or 0
                minutes = seconds / 60
                cost_usd = seconds * price_per_second_usd
                auravox_tokens = cost_usd * 100  # 1 cent = 1 token

                total_minutes += minutes
                total_cost_usd += cost_usd
                total_auravox_tokens += auravox_tokens
                ...
                breakdown.append(
                    {
                        ...
                        "auravox_tokens": round(auravox_tokens, 0),
            ...
            return {
                ...
                "total_auravox_tokens": round(total_auravox_tokens, 0),
                "currency": "USD",
            }
