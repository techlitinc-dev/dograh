...
AURAVOX_MPS_SECRET_KEY = os.getenv("AURAVOX_MPS_SECRET_KEY", None)
MPS_API_URL = os.getenv("MPS_API_URL", "https://services.auravox.ai")
AURAVOX_DEVOPS_SECRET = os.getenv("AURAVOX_DEVOPS_SECRET") or None
