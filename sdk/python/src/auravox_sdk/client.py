...
class AuravoxClient(_GeneratedClient):
    """Sync HTTP client. Suitable for scripts, pytest, and the LLM SDK
    exec sandbox.

    Auth precedence:
        1. `api_key` kwarg
        2. `AURAVOX_API_KEY` env var
    ...
    def __init__(
        ...
        *,
        ...
        resolved_url = base_url or os.environ.get(
            "AURAVOX_API_URL", "http://localhost:8000"
        )
        self.base_url = resolved_url.rstrip("/")
        self.api_key = api_key or os.environ.get("AURAVOX_API_KEY")
    ...
    def __enter__(self) -> AuravoxClient:
        return self
