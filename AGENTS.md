# VoxCRM - Project Overview

VoxCRM is a voice-first CRM SaaS: CRM (contacts, companies, pipeline, tasks) with built-in AI voice agents, campaigns, telephony/WebRTC calling, and analytics. Multi-tenant: end users never configure models or telephony — those are platform-managed.
