...
# The preflight rewrites .env (awk + mv in auravox_set_env_key), so running this
...
AURAVOX_DEPLOY_PROJECT_DIR="$SCRIPT_DIR"
...
auravox_info "Running Auravox remote preflight..."
auravox_prepare_remote_install "$SCRIPT_DIR"
docker compose config -q
auravox_success "✓ auravox-init preflight validated"
...
auravox_sync_postgres_password "$SCRIPT_DIR" "${COMPOSE_CMD[@]}"
