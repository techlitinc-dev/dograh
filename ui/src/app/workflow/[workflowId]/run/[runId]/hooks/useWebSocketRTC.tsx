            ...
            if (response.error) {
                ...
                const message = detailFromError(
                    ...
                    isServiceUnavailable
                        ? 'VoxCRM is temporarily unavailable. Please try again later.'
                        : 'API Key Error',
                );

                if (isServiceUnavailable) {
                    // MPS is a VoxCRM-owned dependency. Do not tell the customer
                    // to change credentials when VoxCRM could not validate them.
