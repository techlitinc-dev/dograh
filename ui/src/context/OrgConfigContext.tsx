...
import type { OrganizationContextResponse, OrganizationPreferences, OrganizationRole, UserConfigurationRequestResponseSchema } from '@/client/types.gen';
    ...
    return (
        <OrgConfigContext.Provider
            value={{
                ...
                role: (orgContext?.role as OrganizationRole | undefined) ?? null,
                orgName: orgContext?.org_name ?? null,
            }}
        >
            {children}
        </OrgConfigContext.Provider>
