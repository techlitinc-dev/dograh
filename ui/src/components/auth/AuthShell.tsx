...
// RIGHT (lg+ only): a brand/value panel with the VoxCRM logo, proof points, and
      ...
      <aside className="relative hidden flex-col justify-between overflow-hidden border-l border-border/60 bg-zinc-950 p-10 lg:flex xl:p-14">
        ...
        <div className="relative max-w-md space-y-5">
          ...
          <p className="text-sm leading-relaxed text-zinc-400">
            AI agents that call your leads, qualify them, and keep your pipeline
            moving — while every conversation flows straight into your CRM.
          </p>
        ...
        <div className="relative mb-12 max-w-md space-y-3 rounded-xl border border-white/10 bg-white/[0.03] p-5 xl:mb-16">
          ...
          <p className="text-sm text-zinc-400">
            We deploy VoxCRM inside your environment for regulated and
            high-scale teams.
          </p>
          {enterpriseSlot}
        </div>
