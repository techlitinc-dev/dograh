...
// Not part of the generated VoxCRM SDK — a different host. All endpoints are PUBLIC
...
const BASE_URL = process.env.NEXT_PUBLIC_ONBOARDING_API_URL || "https://api-leads.auravox.ai";
