...
description: "Connect Auravox to Tuner — the observability, simulation, and testing layer for voice"
---
...
Log in to [Tuner](https://app.usetuner.ai) and create a new agent. When configuring the agent, set the **Provider** to **Auravox**. Enter your **Agent Name** and choose the **Call Direction** (Inbound or Outbound) for your setup. The **Agent Remote ID** is auto-generated after you create the agent.

<img
  src="/images/tuner-create-agent.png"
  alt="Create a New Agent modal in Tuner — set Provider to Auravox"
/>
...
In your Auravox workflow editor, click **Add node** and scroll to the **Integrations** section. Select **Tuner**.
...
<img
  ...
  alt="Auravox Integrations panel showing QA Analysis, Tuner, and Webhook"
/>
...
<img
  ...
  alt="Auravox Edit Tuner modal with credential fields and Enabled toggle"
/>
...
| Wrong agent in Tuner | Confirm the Tuner agent's Provider is set to **Auravox** |
