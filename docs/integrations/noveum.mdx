...
description: "Connect Auravox to Noveum — full-call tracing, audio capture, and AI-powered evaluation for your voice agents"
---
...
The export is **post-call and bring-your-own-key**: while the call is live, Auravox only records data locally — nothing is sent to Noveum and no latency is added to the conversation. After the call finishes, the trace and audio are uploaded in the background using the Noveum API key you configure on the node.
...
In your Auravox workflow editor, click **Add node** and scroll to the **Integrations** section. Select **Noveum**.

<img
  src="/images/tuner-auravox-workflow-builder.png"
  alt="Auravox voice workflow builder — click Add node"
/>
...
<img
  ...
  alt="Auravox Integrations panel showing the Noveum node"
/>
...
<img
  ...
  alt="Auravox Edit Noveum modal with API key, project, environment, and audio fields"
/>
...
<img
  ...
  alt="Noveum trace view showing a Auravox call with per-turn STT, LLM, and TTS spans"
/>
...
- [Noveum documentation](https://noveum.ai/docs) — Complete platform docs, including the [Auravox integration guide](https://noveum.ai/docs/integration-examples/auravox/overview)
