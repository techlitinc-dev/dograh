...
description: "Connect Auravox AI with external services and platforms"
---

## Introduction

Auravox AI provides a flexible integration architecture that allows you to connect with various external services and platforms. Our integration system is designed with modularity and extensibility in mind, making it easy to add new providers while maintaining backward compatibility.
...
- Visit our [GitHub Issues](https://github.com/auravox-hq/auravox/issues) for community support
- Join our [Slack community](https://join.slack.com/t/auravox-community/shared_invite/zt-3zjb5vwvl-j7hRz3_F1SOn5cH~jm5f5g) for assistance