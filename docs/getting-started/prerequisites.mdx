---
title: "Prerequisites"
description: "System requirements and setup needed to run Auravox AI locally"
---
...
To run Auravox AI locally, make sure you have the following installed:
...
Auravox images are available from two registries:

- **GitHub Container Registry (Default)**: `ghcr.io/auravox-hq` - Recommended for most users
- **Docker Hub**: `auravoxai` - Alternative registry
...
REGISTRY=ghcr.io/auravox-hq ./start_docker.sh

# Using Docker Hub
REGISTRY=auravoxai ./start_docker.sh
```
```powershell Windows
# Using GitHub Container Registry (recommended)
$env:REGISTRY = 'ghcr.io/auravox-hq'; .\start_docker.ps1

# Using Docker Hub
$env:REGISTRY = 'auravoxai'; .\start_docker.ps1
```
</CodeGroup>
