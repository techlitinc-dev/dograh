...
<iframe
  ...
  title="How to Build Your First Voice Agent in Auravox"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
></iframe>

<Note>
Using the hosted platform, go to [app.auravox.ai](https://app.auravox.ai). Self-hosting locally? Use `http://localhost:3010` instead, and follow [Getting Started](/getting-started) first to get the platform running.
</Note>

## Step 1: Create an agent

Go to [app.auravox.ai/workflow](https://app.auravox.ai/workflow) and create a new agent.
