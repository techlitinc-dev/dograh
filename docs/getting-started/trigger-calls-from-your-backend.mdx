...
If your team is manually dialing leads one by one, or your CRM needs to kick off a call the moment a lead comes in, this is how you automate that with Auravox.
...
```bash
curl -X POST https://api.auravox.ai/api/v1/public/agent/test/{uuid} \
