---
title: "Overview"
description: "Interact with Auravox programmatically via the REST API"
---
...
```
https://your-auravox-instance/api/v1
```

If you are using the hosted version, the base URL is `https://app.auravox.ai/api/v1`.
...
```bash
curl -X POST https://your-auravox-instance/api/v1/workflow/create/definition \
...
```bash
curl https://your-auravox-instance/api/v1/health
```
...
```json
{
  "status": "ok",
  "version": "1.0.0",
  "backend_api_endpoint": "https://your-auravox-instance",
  "deployment_mode": "oss",
  "auth_provider": "local"
}
```
