# Auravox SDK Examples

Runnable examples of the Auravox SDK in Python and TypeScript.
...
export AURAVOX_API_ENDPOINT=http://localhost:8000
export AURAVOX_API_TOKEN=sk-...
